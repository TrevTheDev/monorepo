...
export interface MinimumSafeParsableRestArray {
  ...
  nullable(): MinimumSafeParsableRestArray
  mullish(): MinimumSafeParsableRestArray
...
export interface SafeParsableRestArray<T extends MinimumSafeParsableArray>
  ...
  vArray: T
  optional(): ReturnType<ReturnType<T[InternalPartial]>['required']>['spread']
  required(): ReturnType<T['required']>['spread']
}

export function parseInfiniteRestArray(
